                ...
                <div class="nav-header">
                        ...
                        @if($user->image)
                                <div class="profile-pic">
                                    <img src="{{ asset('storage/'.$user->image) }}" alt="" srcset=""  width="50px" height="50px" style="border-radius:100%">
                    ...
                    <div class="each-tweet" id="postid-{{$owners->id}}-reply-btn-parent">
                        ...
                        <div class="each-tweet-content">
                            <div class="profile-pic-wrapper">
                                @if($owners->user->image)
                                
                                    <div class="profile-pic">
                                        <img src="{{ asset('storage/'.$owners->user->image) }}" alt="" srcset=""  width="50px" height="50px" style="border-radius:100%">
